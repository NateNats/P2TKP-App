...
public class NormaIST {
    ...
    private static void initializeDataMap() {
        ...
        stdScoreMap.put(31, 20);
        stdScoreMap.put(30, 19);
        stdScoreMap.put(29, 18);
        stdScoreMap.put(28, 17);
        stdScoreMap.put(27, 16);
        stdScoreMap.put(26, 16);
        stdScoreMap.put(25, 15);
        stdScoreMap.put(23, 14);
        stdScoreMap.put(24, 13);
        stdScoreMap.put(22, 13);
        stdScoreMap.put(21, 12);
        stdScoreMap.put(20, 11);
        stdScoreMap.put(19, 11);
        stdScoreMap.put(18, 10);
        stdScoreMap.put(17, 10);
        stdScoreMap.put(16, 9);
        stdScoreMap.put(15, 9);
        stdScoreMap.put(14, 9);
        stdScoreMap.put(13, 8);
        stdScoreMap.put(12, 8);
        stdScoreMap.put(11, 8);
        stdScoreMap.put(10, 7);
        stdScoreMap.put(9, 7);
        stdScoreMap.put(8, 6);
        stdScoreMap.put(7, 6);
        stdScoreMap.put(6, 5);
